...
export const ECOSISTEMA_PRODUCTS: SeedProduct[] = [
  ...
  // Los otros cinco programas de la página Actúa del hub. Reunión 5-sep-2026:
  // cada botón "Quiero este programa" debe llevar a su ficha para comprarlo.
  {
    name: "PHB ACTÚA Metabólico",
    slug: "phb-actua-metabolico",
    productType: "program",
    deliveryMethod: "platform-access",
    price: 0,
    currency: "MXN",
    shortDescription: "Para sobrepeso, resistencia a la insulina, glucosa elevada y sedentarismo.",
    format: "Programa conductual · 30 días",
    idealFor: "Quien necesita revertir marcadores metabólicos con acción sostenida.",
    timeRequired: "30 días",
    priceOnRequest: true,
    categorySlugs: ["actua"],
    themes: ["comportamiento", "prevencion"],
    _fuente: "Página Actúa del hub: tagline e 'ideal para' ya publicados y revisados con el cliente.",
    _pendiente: "PRECIO SIN DEFINIR. Mientras tanto se muestra 'Precio a confirmar' y no es comprable.",
  },
  {
    name: "PHB ACTÚA Preventivo",
    slug: "phb-actua-preventivo",
    productType: "program",
    deliveryMethod: "platform-access",
    price: 0,
    currency: "MXN",
    shortDescription: "Para quien está bien y quiere seguir estándolo.",
    format: "Programa conductual · 30 días",
    idealFor: "Personas sanas que quieren blindar sus hábitos a futuro.",
    timeRequired: "30 días",
    priceOnRequest: true,
    categorySlugs: ["actua"],
    themes: ["comportamiento", "prevencion"],
  ...
  },
  {
    ...
    price: 0,
    currency: "MXN",
    shortDescription: "Preservar energía, fuerza, función y autonomía.",
    format: "Programa conductual · 30 días",
    idealFor: "Personas de 50 años en adelante que priorizan independencia funcional.",
    timeRequired: "30 días",
    priceOnRequest: true,
    categorySlugs: ["actua"],
    themes: ["comportamiento", "longevidad"],
    _fuente: "Página Actúa del hub: tagline e 'ideal para' ya publicados y revisados con el cliente.",
    _pendiente: "PRECIO SIN DEFINIR. Mientras tanto se muestra 'Precio a confirmar' y no es comprable.",
  },
  {
    name: "PHB ACTÚA Diabetes",
    slug: "phb-actua-diabetes",
    productType: "program",
    deliveryMethod: "platform-access",
    price: 0,
    currency: "MXN",
    shortDescription: "Acompañamiento conductual para vivir con diabetes con mayor control.",
    format: "Programa conductual · 30 días",
    idealFor: "Personas que viven con diabetes y buscan mayor control diario.",
    timeRequired: "30 días",
    priceOnRequest: true,
    categorySlugs: ["actua"],
    themes: ["comportamiento", "prevencion"],
  ...
  },
  {
    ...
    currency: "MXN",
    shortDescription:
      "Preparación y sostenimiento conductual alrededor de una estrategia regenerativa.",
    format: "Programa conductual · 30 días",
    idealFor: "Quien está en o considera una estrategia de medicina regenerativa.",
    timeRequired: "30 días",
    priceOnRequest: true,
    categorySlugs: ["actua"],
    themes: ["comportamiento", "regeneracion"],
    _fuente: "Página Actúa del hub: tagline e 'ideal para' ya publicados y revisados con el cliente.",
    _pendiente: "PRECIO SIN DEFINIR. Mientras tanto se muestra 'Precio a confirmar' y no es comprable.",
  },
